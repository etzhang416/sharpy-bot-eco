...
class ScoutLocation(ScoutBaseAction):
    ...
    @staticmethod
    def scout_main_2(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-1].behind_mineral_position_center.
                             towards(k.expansion_zones[-1].mineral_line_center, 20).random_on_distance(5), **kwargs)
    ...
    @staticmethod
    def scout_enemy8(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[-8].center_location, **kwargs)
    ...
    @staticmethod
    def scout_own2_behind(**kwargs) -> ScoutBaseAction:
        return ScoutLocation(lambda k: k.expansion_zones[1].behind_mineral_position_center, **kwargs)
